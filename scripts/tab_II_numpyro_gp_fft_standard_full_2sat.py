...
model_name = "fixed_orbit_rfi_full_fft_standard_2sat"
...
sim_dir = "/home/users/f/finlay/tabascal/tabascal/tabascal/examples/data"
...
rfi_induce = jnp.array(
    [
        vmap(jnp.interp, in_axes=(None, None, 1))(
            rfi_times, times_fine, rfi_A_app[i, :, :, 0]
        )
...
rfi_A_perturb = jnp.transpose(rfi_A_app[..., 0], axes=(0, 2, 1)) * traj_phase_error
